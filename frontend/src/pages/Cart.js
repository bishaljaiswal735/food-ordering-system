...
import { FaTrash, FaPlus, FaMinus, FaShoppingCart, FaRupeeSign } from 'react-icons/fa';
          ...
          <>
                      ...
                      <div className="col-md-8">
                        <div className="card-body">
                          ...
                          <p className="fw-bold text-success">
                            <FaRupeeSign className="me-1" />{item.food.item_price}
                          </p>
            ...
            <div className="card p-4 mt-4 border-0 shadow-sm">
              <h4 className="text-end">
                Total: <FaRupeeSign className="me-1" />{grandTotal.toFixed(2)}
              </h4>
