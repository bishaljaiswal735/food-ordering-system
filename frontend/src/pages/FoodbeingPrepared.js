...
function FoodbeingPrepared() {
  const [orders, setOrders] = useState([]);

  useEffect(() => {
    fetch("http://127.0.0.1:8000/api/foodbeing_prepared/")
      .then(res => res.json())
  ...
  return (
    <AdminLayout>
      ...
      <div className="container mt-4">
        <h3 className="text-center text-primary mb-4">Detail of Order being Prepared</h3>
